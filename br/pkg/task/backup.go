...
// TxnBackupConfig is the configuration specific for backup tasks.
...
func (cfg *TxnBackupConfig) ParseFromFlags(flags *pflag.FlagSet) error {
...
// adjustBackupConfig is use for BR(binary).
...
func RunTxnBackup(c context.Context, g glue.Glue, cmdName string, cfg *TxnBackupConfig) error {
	...
	// Metafile size should be less than `MetaFileSize`.
